            ...
            <div className="product-card is-active">
              <div className="product-card__img">
                <picture>
                  ...
                  >
                    <img src="img/content/fast-shot.jpg"
                      srcSet="img/content/fast-shot@2x.jpg 2x" width="280" height="240" alt="Фотоаппарат FastShot MR-5"
                    >
                    </img>
                  </source>
                </picture>
              ...
              <div className="product-card__img">
                <picture>
                  <source type="image/webp" srcSet="img/content/das-auge.webp, img/content/das-auge@2x.webp 2x">
                    <img src="img/content/das-auge.jpg" srcSet="img/content/das-auge@2x.jpg 2x"
              ...
              <div className="product-card__img">
                <picture>
                  <source type="image/webp" srcSet="img/content/instaprinter.webp, img/content/instaprinter@2x.webp 2x">
                    <img src="img/content/instaprinter.jpg"
            ...
            <div className="product-card">
              <div className="product-card__img">
                <picture>
                  ...
                  >
                    <img src="img/content/das-auge.jpg"
                      srcSet="img/content/das-auge@2x.jpg 2x" width="280" height="240" alt="Ретрокамера «Das Auge IV»"
                    >
                    </img>
                  </source>
                </picture>
            ...
            <div className="product-card">
              <div className="product-card__img">
                <picture>
                  ...
                  >
                    <img src="img/content/instaprinter.jpg"
                      srcSet="img/content/instaprinter@2x.jpg 2x" width="280" height="240" alt="Фотоаппарат Instaprinter P2"
                    >
                    </img>
                  </source>
                </picture>
